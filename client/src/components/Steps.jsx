...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
      <h1 className='text-center text-2xl md:text-3x1 lg:text-4x1 mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text tex-transparent'>Steps to remove background <br /> image in seconds</h1>
